...
const columns=[
    {id:'codigo',label:'Código',minWidth:150},
    {id:'nombre',label:'Nombre',minWidth:170},
    {id:'dias',label:'Días',minWidth:200}
  ]
  
  function createData(codigo,nombre,dias){
      return{codigo,nombre,dias};
  }
  const rows =[
...
export default function Penalizacion(){
    ...
    return(
        ...
        <h2 className='text-danger m-3 mb-4'><strong>Listado estudiantes incurrentes en *no* comprar</strong></h2>
