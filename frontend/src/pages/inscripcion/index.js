...
export default function Inscripcion(){
    ...
    return(
        ...
        <Button variant="contained" className="rounded-3 secondary m-3" type="submit"><a href="/login" className="text-decoration-none" style={{color:'white'}}>Cancelar</a></Button>
